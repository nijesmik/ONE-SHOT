...
INSERT INTO user
(user_email, password, nick_name, admin, service)
VALUES
("ssafy@ssafy.com", "1234", "비회원", 0, 1),
("junghoon1039@gmail.com", "1234", "관리자", 1, 1)
;
...
CREATE TABLE IF NOT EXISTS `menu` ( -- 메뉴 정보를 저장하는 테이블 | 브랜드에 귀속
  ...
  `capacity` VARCHAR(256) COMMENT '메뉴 용량',
  `calorie` VARCHAR(256) COMMENT '메뉴 칼로리',
